...
<?php
	...
	$tot_sks += $value['jum_sks'];
		...
		echo '<td>'.$value['nama_dosen'].'</td>
				...
				<td align="center"><a href="'.base_url().'dosen/form_input_nilai/'.$value['nim'].'/'.$value['kd_jadwal'].'" class="link"
...
?>
		...
		foreach($khs->result_array() as $value)
		{
			if($temp=='')
			{
				...
				<td align="center"><a href="'.base_url().'dosen/edit_nilai/'.$value['nim'].'/'.$value['kd_mk'].'" class="link"
				rel="example_group">Edit</a></td>
				<td align="center"><a href="'.base_url().'dosen/hapus_nilai/'.$value['nim'].'/'.$value['kd_mk'].'" class="link"
