...
<form method="post" action="<?php echo base_url(); ?>dosen/simpan_nilai">
<?php
...
<td width="50">:</td>
<td><input type="text" name="semester_ditempuh" size="50" class="input-read-only" value="<?php echo $e['semester_ditempuh']; ?>" /></td>
</tr>

<tr>
<td width="180">Nilai</td>
<td width="50">:</td>
<td><input type="text" name="grade" size="50" class="input-read-only" value="<?php echo $e['grade']; ?>" /></td>
</tr>
